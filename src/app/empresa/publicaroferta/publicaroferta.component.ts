...
export class PublicarofertaComponent {
  ...
  areas: Area[] = [
    ...
    {value: 'Advisory'},
    {value: 'Consulting'},
    {value: 'Corporate Affairs/Communication'},
    {value: 'Customer Service'},
    {value: 'Facilities/Fleet Management'},
    {value: 'Finance'},
    ...
    {value: 'Public Relations/Investor Relations'},
    {value: 'Research & Analytics'},
    {value: 'Sales'},
    {value: 'Stretegy/Planning/Corporate Development'},
  ...
  ngOnInit() {
    ...
    $( "#oferta-privada" ).click(function() {
      $( "#seccion-oferta" ).slideToggle();
     });

    $( "#checkPerson" ).click(function() {
      $( "#numPerson" ).slideToggle();
     });
